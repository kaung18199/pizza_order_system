                    ...
                    <div class="table-data__tool">
                        <div class="table-data__tool-left">
                            <div class="overview-wrap">
                                <h2 class="title-1">Product List
                                    <span class=" btn btn-outline-dark"><i class="fa-solid fa-database"></i>  - {{$pizzas->total()}}  </span>
                                </h2>
                        ...
                        <table class="table table-data2 text-center">
                            ...
                            <tbody>
                                <tr class="tr-shadow">
                                    ...
                                    <tr class="tr-shadow">
                                        <td class=" col-2">
                                            <img src="{{ asset('storage/'.$p->image) }}" alt="" class=" img-thumbnail shadow-sm w-75">
                                        </td>
