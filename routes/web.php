...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['admin_auth'])->group(function(){
        ...
        Route::prefix('admin')->group(function(){
            ...
            Route::get('ajax/change/user',[AdminController::class,'ajaxChangeUser'])->name('admin#ajaxChangeUser');
    ...
    Route::group(['prefix'=>'user','middleware'=>'user_auth'],function(){
        ...
        //contact
        Route::prefix('contact')->group(function(){
            Route::get('home',[ContactController::class,'contactHome'])->name('user#contactHome');
            Route::post('messageSend',[ContactController::class,'messageSend'])->name('user#messageSend');
        });
